...
cv_linear <- cv_msgamlss(x = x_lin, y=y_lin, init_probs_list = init_state_probs_list, formula = formula, states = states_lin, type ="MSGLMLSS", max_iter = 100, mstop = c(500,500))
